    ...
    <div className="GridPage">
      ...
      <section className="bg-faded py-5 d-print-none">
        <div className="container">
          ...
          <p>
            Each kea survey grid tile matches the ID of a bird atlas 10km by
            10km tile, but has been further divided into four 5km by 5km tiles
            with one of four cardinal marker suffixes (NW/NE/SW/SE).
          </p>
          <div className="row">
