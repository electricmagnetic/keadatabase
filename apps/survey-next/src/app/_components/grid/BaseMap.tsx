...
const LINZ_SUBDOMAINS = ["a", "b", "c", "d"];

const LINZ_TOPO_50K = LINZ_SUBDOMAINS.map(
  (subdomain) =>
    `https://tiles-${subdomain}.data-cdn.linz.govt.nz/services;key=${LINZ_API_KEY}/tiles/v4/layer=50767/EPSG:3857/{z}/{x}/{y}.png`,
);
const LINZ_TOPO_250K = LINZ_SUBDOMAINS.map(
  (subdomain) =>
    `https://tiles-${subdomain}.data-cdn.linz.govt.nz/services;key=${LINZ_API_KEY}/tiles/v4/layer=50798/EPSG:3857/{z}/{x}/{y}.png`,
);
